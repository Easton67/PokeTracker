...
print '' print '*** inserting Pokemon test records ***'
GO
...
VALUES
	('Night', 'night.jpeg', 'Perfect playlist for once it gets dark out', 100000),
	('Day', 'day.jpeg', 'Great for when its nice and sunny outside', 100000),
